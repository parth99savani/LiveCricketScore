 ...
 */
public class WAllRounderRankingFragment extends Fragment {
    ...
    private static final String URL_DATA = "https://cricketapi-icc.pulselive.com/icc-ratings/ranked/players/wodi/allround?page=0&pageSize=20";
    private static final String URL_T20_DATA = "https://cricketapi-icc.pulselive.com/icc-ratings/ranked/players/wt20i/allround?page=0&pageSize=20";

    public WAllRounderRankingFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_w_all_rounder_ranking, container, false);
    ...
    private void loadOdiData() {
        StringRequest stringRequest = new StringRequest(Request.Method.GET,
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Log.e("WAllRoundRankFragment","Error" + error.toString());
            }
        });
